...
const MobileAddMoney = ({ onClose, onAdd, isDarkMode }: MobileAddMoneyProps) => {
    ...
    return (
        <div
            className={`flex flex-col h-full bg-transparent overlay-gradient-bg absolute inset-0 z-[60] overflow-hidden ${isClosing ? "animate-out slide-out-to-right duration-300" : "animate-in slide-in-from-right duration-300"
                }`}
        >
            {success && (
                <TransactionReceipt
