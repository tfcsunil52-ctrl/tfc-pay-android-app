...
const services = {
    recharge: [
        ...
        { icon: "/New icons/Layer 10.webp", title: "Metro Card", description: "Recharge metro card" },
    ...
    premium: [
        ...
        { icon: "/New icons/Layer 21.webp", title: "CC Bill Payment", description: "Credit card bill" },
        { icon: "/New icons/Layer 26.webp", title: "Credit Card EMI", description: "EMI payments" },
        { icon: "/New icons/Layer 24.webp", title: "Insurance", description: "Health, Vehicle" },
